        ...
        <div className="flex-1 border border-gray-200 py-7 px-10 rounded-xl max-w-md mx-8 font-sans">
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 items-center">
                    <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-1.5 rounded-lg outline-none my-3 max-w-20">signUp</button>
                    <Link href='/login' className="text-sm underline underline-offset-8 text-blue-500">Already have an account?</Link>
                </div>
            </div>
        </div> 
      </div>
